package test.sombra.manufacturer.dao;
 ...
 */
@Component
public class ManufacturerDAO implements DAO<Manufacturer, Long> {
    ...
    @Autowired
    public ManufacturerDAO(JdbcTemplate jdbcTemplate, ManufacturerRowMapper manufacturerRowMapper) {
